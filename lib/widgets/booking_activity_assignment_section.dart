// lib/widgets/booking_activity_assignment_section.dart
...
///
/// คัดลอกจาก [BookingRoomAssignmentSection] แต่แสดง bookdetail ของห้องกิจกรรม
/// (เรียก room-assignments ด้วย type 'C') เรียงตามลำดับ (sequence)
...
class BookingActivityAssignmentSection extends StatefulWidget {
  ...
  @override
  State<BookingActivityAssignmentSection> createState() =>
      _BookingActivityAssignmentSectionState();
}
...
class _BookingActivityAssignmentSectionState
  ...
  @override
  void didUpdateWidget(covariant BookingActivityAssignmentSection oldWidget) {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (AppLogger.on) AppLogger.d('Error loading activity assignments: $e');
      if (!mounted) return;
      setState(() {
        _error = _describeApiError(e, 'ดึงรายการห้องกิจกรรมที่กำหนดแล้ว');
        _loading = false;
      });
    }
  }
  ...
  Future<void> _delete(RoomAssignment r) async {
    ...
    final confirmed = await AppDialog.showConfirm(
      context,
      'ต้องการลบห้องนี้ออกจากการกำหนดห้องกิจกรรมใช่หรือไม่?\n'
...
/// หัวคอลัมน์ของตารางห้องกิจกรรมที่กำหนดแล้ว
